...
export const Salesman = () => {
    ...
    const deleteData = async (params) => {
        try {
            await axios.delete(
                `${process.env.REACT_APP_API_BASE_URL}/salesman/${params}`
            );
            dataFetching();
    ...
    const submitClick = async (e) => {
        ...
        } catch (error) { toast.warn("Code Sudah Digunakan", {
            position: "top-center",
            autoClose: 3000,
        ...
        <div>
            ...
            <table className='border-separate border-spacing-2 w-1/2'>
                ...
                <tr>
                    ...
                    <td>
                        <input onChange={(e)=>{setAddress(e.target.value)}} type="text" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Isi alamat" required />
                    </td>
                </tr>
                <tr>
                    <td className='text-right'>City: </td>
                    <td>
                        <input type="text" onChange={(e) => {setCity(e.target.value)}} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Isi kota" required />
                    </td>
                </tr>
                <tr>
                    <td className='text-right'>Phone: </td>
                    <td>
                        <input onChange={(e)=>{setPhone(e.target.value)}} type="text" pattern="[0-9]+" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Isi nomor telpon" required />
                    </td>
                </tr>
                <tr>
                    <td className='text-right'>Mobile: </td>
                    <td>
                        <input onChange={(e)=>{setMobile(e.target.value)}} type="text"  className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Isi nomor hp" required />
                    </td>
                </tr>
                <tr>
                    <td></td>
