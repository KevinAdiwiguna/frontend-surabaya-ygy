...
export const Unit = () => {
  ...
  const dataFetching = async () => {
    try {
      const data = await axios.get(`${process.env.REACT_APP_API_BASE_URL}/unit`);
  ...
  const deleteData = async (params) => {
    try {
      await axios.delete(`${process.env.REACT_APP_API_BASE_URL}/unit/${params}`);
      dataFetching();
  ...
  const updateData = async (params) => {
    try {
      await axios.patch(`${process.env.REACT_APP_API_BASE_URL}/unit/${params}`, {
        name: nameUpdate,
  ...
  const submitClick = async (e) => {
    e.preventDefault();
    try {
      await axios.post(`${process.env.REACT_APP_API_BASE_URL}/unit`, {
        code: code,
        name: name,
